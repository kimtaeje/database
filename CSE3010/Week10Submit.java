...
public class Week10Submit implements ActionListener {
	...
	public void task2() {
		...
		idLabel.setBounds(20,10,100,35);
		pwdLabel.setBounds(130,10,100,35);
		idInput.setBounds(20,45,100,35);
		pwdInput.setBounds(130,45,100,35);
		loginButton.setBounds(20,100,100,35);
		getTablesButton.setBounds(130,100,100,35);
		statusLabel.setBounds(10,130,300,35);
		statusMessageLabel.setBounds(10,160,300,35);
